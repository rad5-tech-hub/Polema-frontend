  ...
  return (
    <>
      ...
      <div className="data-boxes flex gap-2 text-white mt-6">
        <div className="bg-theme min-h-[150px] rounded p-5 w-full text-white">
          <h1 className="text-[12px] font-bold font-space mb-5">Customers</h1>
          <p className="text-center text-[13px]">Number of people that has bought from POLEMA</p>
          <p className="text-center text-[3rem] font-amsterdam">{customers}</p>
        </div>
        <div className="bg-theme/10 min-h-[150px] rounded p-5 w-full text-black">
          <h1 className="text-[12px] font-bold font-space mb-4">Suppliers</h1>
          <p className="text-center text-[13px]">Number of people that POLEMA has done business with</p>

          <p className="text-center text-[3rem] font-amsterdam">{suppliers}</p>
        </div>
        <div className="bg-theme/10  min-h-[150px] rounded p-5 w-full text-black">
          <h1 className="text-[12px] font-bold font-space mb-4">Products</h1>
          <p className="text-center text-[13px]">Number of products produced and sold in POLEMA</p>

          <p className="text-center text-[3rem] font-amsterdam">{products}</p>
        </div>
        <div className="bg-theme/10 min-h-[150px] rounded p-5 w-full text-black">
          <h1 className="text-[12px] font-bold font-space mb-4">Raw Materials</h1>
          <p className="text-center text-[13px]">Number of raw materials POLEMA buys for production</p>

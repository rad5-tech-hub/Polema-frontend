...
//   // Function to remove commas from the amount string
//   function removeCommas(numberStr) {
//     return numberStr ? parseFloat(numberStr.replace(/,/g, "")) : "";
//   }
...
//     const body = {
//       staffName,
//       amount: removeCommas(staffAmount),
//       item: itemName,
//       creditOrDebit: authorityType,
//       comments,
//       departmentId,
...
//                       setStaffAmount("");
//                     } else if (!isNaN(rawValue) && rawValue !== "") {
//                       setStaffAmount(formatWithCommas(rawValue));
//                     }
//                   }}
//                 >
//                   <TextField.Slot>₦</TextField.Slot>
